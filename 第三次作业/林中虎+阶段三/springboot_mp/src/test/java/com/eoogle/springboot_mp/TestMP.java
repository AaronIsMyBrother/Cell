...
public class TestMP {
    ...
    private static String author ="Eoogle";//作者名称
    private static String outputDir ="D:\\code\\java\\springboot_mp\\src\\main\\java";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/springboot1?serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="331295045";//数据库密码
    private static String tablePrefix ="tbl_";//数据库表的前缀，如tbl_user
    private static String [] tables = {"tbl_employee"};	//生成的表
    private static String parentPackage = "com.eoogle";//顶级包结构
